  ...
  <body>
        ...
        <div class="container me-2" id="detailBodyContent">
          ...
          <div class="d-flex">
            ...
            <div class="container-fluid">
              ...
              <p>Bukti : </p>
              <div class="d-flex">
                <a href="#" data-bs-target="#modalLihatFoto1" data-bs-toggle="modal"><img src="data:image/jpeg;base64,<?php echo base64_encode($details->bukti_reimbursement); ?>" alt="" width="80px" height="80px" class="me-2 rounded"></a>
                <a href="#" data-bs-target="#modalLihatFoto2" data-bs-toggle=""><img src="data:image/jpeg;base64,<?php echo base64_encode($details->bukti_reimbursement2); ?>" alt="" width="80px" height="80px" class="me-2 rounded"></a>
                <a href="#" data-bs-target="#modalLihatFoto3" data-bs-toggle=""><img src="data:image/jpeg;base64,<?php echo base64_encode($details->bukti_reimbursement3); ?>" alt="" width="80px" height="80px" class="me-2 rounded"></a>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="modal-body">
              <div class="d-flex">
                ...
                <div class="container">
                  ...
                  <div class="d-flex">
                    <a href="#" data-bs-target="#modalLihatFoto1" data-bs-toggle="modal"><img src="data:image/jpeg;base64,<?php echo base64_encode($details->bukti_reimbursement); ?>" alt="" width="80px" height="80px" class="me-2 rounded"></a>
                    <a href="#" data-bs-target="#modalLihatFoto2" data-bs-toggle="modal"><img src="data:image/jpeg;base64,<?php echo base64_encode($details->bukti_reimbursement2); ?>" alt="" width="80px" height="80px" class="me-2 rounded"></a>
                    <a href="#" data-bs-target="#modalLihatFoto3" data-bs-toggle="modal"><img src="data:image/jpeg;base64,<?php echo base64_encode($details->bukti_reimbursement3); ?>" alt="" width="80px" height="80px" class="me-2 rounded"></a>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content rounded-4">
          <div class="modal-body text-center">
            <img src="data:image/jpeg;base64,<?php echo base64_encode($details->bukti_reimbursement); ?>" alt="" width="550px" height="550px" class="me-2 rounded">
          </div>
        </div>
      </div>
    </div>
    <div class="modal fade" id="modalLihatFoto2">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content rounded-4">
          <div class="modal-body text-center">
            <img src="data:image/jpeg;base64,<?php echo base64_encode($details->bukti_reimbursement2); ?>" alt="" width="550px" height="550px" class="me-2 rounded">
          </div>
        </div>
      </div>
    </div>
    <div class="modal fade" id="modalLihatFoto3">
      <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content rounded-4">
          <div class="modal-body text-center">
            <img src="data:image/jpeg;base64,<?php echo base64_encode($details->bukti_reimbursement3); ?>" alt="" width="550px" height="550px" class="me-2 rounded">
          </div>
        </div>
      </div>
    </div>
